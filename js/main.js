...
function addAll() {
  const inp = document.getElementsByClassName('inputBox');//collects user inputs from all questions
  for (i of inp) {
    values.push(i.value);
    i.value = "";
    console.log(values)
...
function mashSelect() {
  document.getElementsByClassName("M")[0].classList.remove("show2");
  document.getElementsByClassName("M")[0].classList.add("hidden2");
  const selectM = setTimeout(M, 500);

  function M() {
    document.getElementsByClassName("M")[0].classList.remove("hidden2");
    document.getElementsByClassName("M")[0].classList.add("show2");

    document.getElementsByClassName("A")[0].classList.remove("show2");
    document.getElementsByClassName("A")[0].classList.add("hidden2");
    const selectA = setTimeout(A, 500);

    function A() {
      document.getElementsByClassName("A")[0].classList.remove("hidden2");
      document.getElementsByClassName("A")[0].classList.add("show2");

      document.getElementsByClassName("S")[0].classList.remove("show2");
      document.getElementsByClassName("S")[0].classList.add("hidden2");
      const selectS = setTimeout(S, 500);

      function S() {
        document.getElementsByClassName("S")[0].classList.remove("hidden2");
        document.getElementsByClassName("S")[0].classList.add("show2");

        document.getElementsByClassName("H")[0].classList.remove("show2");
        document.getElementsByClassName("H")[0].classList.add("hidden2");
        const selectH = setTimeout(H, 500);

        function H() {
          document.getElementsByClassName("H")[0].classList.remove("hidden2");
          document.getElementsByClassName("H")[0].classList.add("show2");
